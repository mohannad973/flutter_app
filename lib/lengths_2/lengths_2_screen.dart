...
import 'package:ora_app/lengths_2/body.dart';
...
class LengthesScreen2 extends StatelessWidget {

  final Cat cat;
  final Diameter diameter;

  const LengthesScreen2({Key key, this.cat,this.diameter}) : super(key: key);
        ...
        body: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              ...
              return LengthsBody(diameter: diameter, cat: cat,diam: diameterValue,prosColorCode: prosthColorCode, surgColorCode: surgColorCode,lengthsList: lengths,surgicalSequenceList: surgicalSequenceList,);
            } else {
              return Center(
